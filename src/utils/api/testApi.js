...
// запросы с параметрами можно перенести внутрь класса чтобы потестировать со своими данными
// запрос токенов

// запрос обновления обновления токена
...
// запрос записи на участие в событии
